  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Fresh Agra, your premier online marketplace for the freshest produce and delectable foods. Indulge in quality and convenience at your fingertips."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Fresh Agra, your premier online marketplace for the freshest produce and delectable foods. Indulge in quality and convenience at your fingertips.`}
            </Text>
            <Box
